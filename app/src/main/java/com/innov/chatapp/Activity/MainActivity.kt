...
import com.innov.chatapp.Activity.adapter.UserAdapter
...
class MainActivity : AppCompatActivity() {
    ...
    var userrsAdapter : UserAdapter? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        userrsAdapter = UserAdapter(this@MainActivity,users!!)
        ...
        binding!!.mRec.adapter =userrsAdapter
        database!!.reference.child("users").addValueEventListener(object : ValueEventListener{
            override fun onDataChange(snapshot: DataSnapshot) {
               users!!.clear()
                ...
                userrsAdapter!!.notifyDataSetChanged()
            }
